export default {
  ...
  searchInformation: {
    ...
    totalResults: "942000000",
    formattedTotalResults: "942,000,000",
  },
  items: [
    {
      ...
      snippet:
        "Jul 20, 2021 ... The value null represents the intentional absence of any object value. It is one of JavaScript's primitive values and is treated as falsy ...",
      htmlSnippet:
        "Jul 20, 2021 \u003cb\u003e...\u003c/b\u003e The value \u003cb\u003enull\u003c/b\u003e represents the intentional absence of any object value. It is one of JavaScript&#39;s primitive values and is treated as falsy&nbsp;...",
    ...
    },
    {
      ...
      htmlSnippet:
        "1 : having no legal or binding force : invalid a \u003cb\u003enull\u003c/b\u003e contract &middot; 2 : amounting to nothing : nil the \u003cb\u003enull\u003c/b\u003e uselessness of the wireless transmitter that lacks a&nbsp;...",
    ...
    },
    {
      ...
      snippet:
        "Computing[edit] · Null (SQL) (or NULL), a special marker and keyword in SQL indicating that something has no value · Null character, the zero-valued ASCII ...",
      htmlSnippet:
        "Computing[edit] &middot; \u003cb\u003eNull\u003c/b\u003e (SQL) (or \u003cb\u003eNULL\u003c/b\u003e), a special marker and keyword in SQL indicating that something has no value &middot; \u003cb\u003eNull\u003c/b\u003e character, the zero-valued ASCII&nbsp;...",
    ...
    },
    {
      ...
      displayLink: "en.wikipedia.org",
      snippet:
        "In inferential statistics, the null hypothesis (often denoted H0) is a default hypothesis that a quantity to be measured is zero (null).",
      htmlSnippet:
        "In inferential statistics, the \u003cb\u003enull\u003c/b\u003e hypothesis (often denoted H0) is a default hypothesis that a quantity to be measured is zero (\u003cb\u003enull\u003c/b\u003e).",
    ...
    },
    {
      ...
      snippet:
        "Jul 20, 2015 ... The null keyword is a literal that represents a null reference, one that does not refer to any object. null is the default value of ...",
      htmlSnippet:
        "Jul 20, 2015 \u003cb\u003e...\u003c/b\u003e The \u003cb\u003enull\u003c/b\u003e keyword is a literal that represents a \u003cb\u003enull\u003c/b\u003e reference, one that does not refer to any object. \u003cb\u003enull\u003c/b\u003e is the default value of&nbsp;...",
    ...
    },
    {
      ...
      snippet:
        "Jul 8, 2021 ... Nullable types and non-null types\ufeff · An explicit call to throw NullPointerException() . · Usage of the !! operator that is described below. · Data ...",
      htmlSnippet:
        "Jul 8, 2021 \u003cb\u003e...\u003c/b\u003e Nullable types and non-\u003cb\u003enull\u003c/b\u003e types\ufeff &middot; An explicit call to throw NullPointerException() . &middot; Usage of the !! operator that is described below. &middot; Data&nbsp;...",
        ...
        metatags: [
          {
            ...
            "og:image":
              "https://kotlinlang.org/assets/images/open-graph/docs.png",
            "og:type": "website",
            "twitter:card": "summary_large_image",
            ...
            "built-on": "2021-10-01T10:22:41.491004",
            "twitter:image:src":
              "https://kotlinlang.org/assets/images/open-graph/docs.png",
            "twitter:site": "@kotlin",
            viewport: "width=device-width,initial-scale=1,maximum-scale=1",
            "og:locale": "en_US",
            "og:url": "https://kotlinlang.org/docs/null-safety.html",
          },
        ],
        cse_image: [
          {
    ...
    {
      kind: "customsearch#result",
      title: "Null Definition & Meaning | Dictionary.com",
      htmlTitle:
        "\u003cb\u003eNull\u003c/b\u003e Definition &amp; Meaning | Dictionary.com",
      link: "https://www.dictionary.com/browse/null",
      displayLink: "www.dictionary.com",
      snippet:
        "null · without value, effect, consequence, or significance. · being or amounting to nothing; nil; lacking; nonexistent. · being or amounting to zero.",
      htmlSnippet:
        "\u003cb\u003enull\u003c/b\u003e &middot; without value, effect, consequence, or significance. &middot; being or amounting to nothing; nil; lacking; nonexistent. &middot; being or amounting to zero.",
    ...
    },
    {
      ...
      link: "https://docs.djangoproject.com/en/3.2/ref/models/fields/",
      displayLink: "docs.djangoproject.com",
      snippet:
        "null ¶ ... If True , Django will store empty values as NULL in the database. Default is False . Avoid using null on string-based fields such as CharField and ...",
      htmlSnippet:
        "\u003cb\u003enull\u003c/b\u003e ¶ ... If True , Django will store empty values as \u003cb\u003eNULL\u003c/b\u003e in the database. Default is False . Avoid using \u003cb\u003enull\u003c/b\u003e on string-based fields such as CharField and&nbsp;...",
      cacheId: "oxNMMrsyxsAJ",
      formattedUrl: "https://docs.djangoproject.com/en/3.2/ref/models/fields/",
      htmlFormattedUrl:
